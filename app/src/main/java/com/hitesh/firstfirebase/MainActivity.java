...
public class MainActivity extends AppCompatActivity
    ...
    private Button buttonFoggy,buttonSunny;
    private FloatingActionButton fab;
    private Toolbar toolbar;
    private Firebase mRef,child;
    ...
    protected void onStart() {
        ...
        buttonSunny.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                child.setValue("Sunny @@");
            }
        });

        mRef=new Firebase("https://firstfirebase-c1321.firebaseio.com");
        child=mRef.child("condition2");
